...
// 
// Configured for P5 by Hoam Chung, June 2010
// Monash University 
//******************************************************************************
...
unsigned char TI_USCI_I2C_slave_present(unsigned char slave_address){
  ...
  ucb1i2cie = UCB0I2CIE;                      // restore old UCB1I2CIE
  uc1ie_bak = IE2;                              // store UC1IE register
  ...
  __enable_interrupt();
  IE2 = uc1ie_bak;                              // restore IE2
  UCB0I2CSA = slaveadr_bak;                   // restore old slave address
  UCB0I2CIE = ucb1i2cie;                      // restore old UCB0CTL1
